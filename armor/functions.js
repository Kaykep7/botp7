...
const banner = cfonts.render(('   P7 BOT \n 2.0'), {
    font: 'block',
    align: 'center',
...
const banner2 = cfonts.render(('By: - P7 - '), {
    font: 'chrome',
    align: 'center',
...
const banner3 = cfonts.render((`  P7 BOT \n 2.0`), {
font: 'simple',
color: 'system',
align: 'center',
colors: [`${cor1}`,`${cor3}`,`${cor4}`,`${cor2}`],
...
if (!packname) packname = 'P7-BOT'; if (!author) author = 'P7';	
...
chyt = `558491661252@s.whatsapp.net`
